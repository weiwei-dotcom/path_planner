...
static const _GetPathpoints_type_support_symbol_names_t _GetPathpoints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, msg, GetPathpoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, msg, GetPathpoints)),
  }
};
...
{
  return &::interface::msg::rosidl_typesupport_cpp::GetPathpoints_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interface, msg, GetPathpoints)() {
  return get_message_type_support_handle<interface::msg::GetPathpoints>();
}
