...
bool interface__msg__get_pathpoints__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface.msg._get_pathpoints.GetPathpoints", full_classname_dest, 43) == 0);
  }
  interface__msg__GetPathpoints * ros_message = _ros_message;
  {  // path_points
...
{
  /* NOTE(esteve): Call constructor of GetPathpoints */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface.msg._get_pathpoints");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetPathpoints");
